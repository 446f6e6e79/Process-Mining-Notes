...
\end{table}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{../images/exercises/alpha_miner-1.png}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{../images/exercises/Heuristic_Miner-3.png}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{../images/exercises/region_miner-1.png}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{../images/exercises/region_miner-2_1.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{../images/exercises/region_miner-2_2.png}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{../images/exercises/region_miner-3_1.png}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{../images/exercises/region_miner-3_2.png}
        \caption{Identified Regions from the Transition System}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{../images/exercises/region_miner-3_3.png}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{../images/exercises/inductive_miner-1_1.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.25\textwidth]{../images/exercises/inductive_miner-1_2.png}
    ...
    \]
    Analyzing the log, we can see that is probable to have a parallel cut between \(b,c\) and \(e,f\). 
    All the other cuts are not possible. So, we apply the parallel cut, obtaining the following subgraphs:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.25\textwidth]{../images/exercises/inductive_miner-1_3.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{../images/exercises/inductive_miner-1_4.png}
