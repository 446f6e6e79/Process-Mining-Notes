...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../images/chapters/bpmn/core.png}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            ...
            \begin{minipage}[t]{0.25\textwidth}
                \centering
                \includegraphics[width=\linewidth]{../images/chapters/bpmn/XORsplit.png}
            \end{minipage}\hfill
            \begin{minipage}[t]{0.25\textwidth}
                \centering
                \includegraphics[width=\linewidth]{../images/chapters/bpmn/XORjoin.png}
            \end{minipage}\hfill
        ...
        \begin{figure}[H]
            ...
            \begin{minipage}[t]{0.25\textwidth}
                \centering
                \includegraphics[width=\linewidth]{../images/chapters/bpmn/ANDsplit.png}
            \end{minipage}\hfill
            \begin{minipage}[t]{0.25\textwidth}
                \centering
                \includegraphics[width=\linewidth]{../images/chapters/bpmn/ANDjoin.png}
            \end{minipage}
        ...
        \begin{figure}[H]
            ...
            \begin{minipage}[t]{0.25\textwidth}
                \centering
                \includegraphics[width=\linewidth]{../images/chapters/bpmn/ORsplit.png}
            \end{minipage}\hfill
            \begin{minipage}[t]{0.25\textwidth}
                \centering
                \includegraphics[width=\linewidth]{../images/chapters/bpmn/ORjoin.png}
            \end{minipage}
...
\subsubsection{Rework Loops}
Rework loops are used to model situations where an activity may need to be repeated based on certain conditions.
A rework loop is represented using:
\begin{itemize}
    \item A \textbf{XOR-JOIN gateway}: signals the entry point of the loop;
    \item A \textbf{XOR-SPLIT gateway}: signals the exit point of the loop. 
    It needs to specify both the condition to re-enter the loop and the condition to exit the loop.
\end{itemize}
...
\\\\An \textbf{association link} (dashed line with open arrowheads) is used to connect data objects to activities or events of business processes.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{../images/chapters/bpmn/dataObject.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{../images/chapters/bpmn/dataStore.png}
...
\begin{figure}[H]   
    \centering
    \includegraphics[width=0.4\textwidth]{../images/chapters/bpmn/textAnnotation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../images/chapters/bpmn/poolLane.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../images/chapters/bpmn/messageFlow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../images/chapters/bpmn/subprocess.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{../images/chapters/bpmn/activityloop.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{../images/chapters/bpmn/multiinstance.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../images/chapters/bpmn/eventtable1.png}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../images/chapters/bpmn/eventtable2.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{../images/chapters/bpmn/eventbasedxor.png}
    \caption{Event-based Gateway in BPMN}
\end{figure}
\begin{figure}[H]   
    \centering
    \includegraphics[width=0.6\textwidth]{../images/chapters/bpmn/eventbasedexample.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{../images/chapters/bpmn/abortion.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{../images/chapters/bpmn/errorevent.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../images/chapters/bpmn/boundaryexample.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{../images/chapters/bpmn/non_interrupting.png}
...
\begin{figure}[H]
    \centering  
    \includegraphics[width=0.6\textwidth]{../images/chapters/bpmn/compensation.png}
