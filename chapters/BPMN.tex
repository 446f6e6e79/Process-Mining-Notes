...
\end{figure}
\paragraph{Untyped events:} they are the default events, already introduced in the core elements.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{images/bpmn_analysis/root_analysis.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{images/bpmn_analysis/whywhy.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{images/bpmn_analysis/fishbone.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/bpmn_analysis/issue_reg.png}
