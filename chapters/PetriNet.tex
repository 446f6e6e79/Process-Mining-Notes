...
\end{itemize}
%# TODO: add petriNet modelling?? In my opinion no 
...
\begin{itemize}
    \item It has a single source place start and a single sink place end;
    \item Every trainsition is on a path start to end.
\end{itemize} 
