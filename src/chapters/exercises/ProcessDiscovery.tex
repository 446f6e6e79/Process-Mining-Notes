...
\subsubsection{Exercise 2}
Given the following event log:
\[L_2 = [\langle a,b,d,e \rangle^80, \langle a,d,b,e \rangle^30, \langle a,e \rangle^2, \langle a,b,c,d,e \rangle^10 \]
...
\subsubsection{Exercise 3}
Given the following event log:
\[L_3 = [\langle a,b,d \rangle^100, \langle a,c,b,d \rangle^80, \langle a,b,c,d \rangle^2, \langle a,c,d \rangle^40, \langle a,d \rangle^1 \]
Compute:
\begin{itemize}
